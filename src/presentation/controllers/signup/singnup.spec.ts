...
describe('SingUp Controller', () => {
  ...
  test('Should retrun 400 if no passwordConfirmation is provided', async  () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should retrun 400 if no password Confirmation fails', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should retrun 400 if an invalid email is provided', async () => {
  ...
  test('Should call AddAccount correct values', async () => {
