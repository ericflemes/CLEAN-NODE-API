...
describe('SingUp Controller', () => {
  ...
  test('Should retrun 400 if no passwordConfirmation is provided', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should retrun 400 if no password Confirmation fails', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should call AddAccount correct values', () => {
  ...
  test('Should retrun 200 if valid date is provided', () => {
    const { sut, emailValidatorStub } = makeSut()
    const httpRequest = {
      body: {
        name: 'valid_name',
